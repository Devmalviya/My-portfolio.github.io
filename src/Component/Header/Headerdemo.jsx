    ...
    <header className="shadow sticky z-50 top-0">
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl ">
          ...
          <div
            className={` justify-center items-center w-full lg:flex xl:flex  xl:w-auto lg:w-auto xl:order-1 lg:order-1 ${isMenuOpen? "" : "hidden"}`}
            id="mobile-menu-2"
          >
            <ul className="flex flex-col mt-4 font-medium lg:flex-row xl:flex-row lg:space-x-8 xl:space-x-8 xl:mt-0 lg:mt-0">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block py-2 pr-4 pl-3 duration-200 ${
                      isActive ? "text-black pb-2 border-b  border-yellow-400" : "text-gray-700"
              ...
              <li>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `block py-2 pr-4 pl-3 duration-200 ${
                      isActive ? "text-black border-b  border-yellow-400" : "text-gray-700"
