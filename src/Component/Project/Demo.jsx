...
function Demo(props) {
  ...
  const ProjectData = [
    {
      projectTitle: "Roommate Finder Website Design",
      ProjectDescription:
        " Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae leo nec velit eleifend mollis ut a nunc. Vestibulum in metus id arcu congue blandit. Suspendisse potenti.",
      carts: [
        {
          title: "Sing In Page",
          imageSrc: "src/ProjectImg/roommate/loginPage.png",
        },
        {
          title: "Home Page",
          imageSrc: "src/ProjectImg/roommate/Homepage.png",
        },
        {
          title: "Post Section",
          imageSrc: "src/ProjectImg/roommate/postSection.png",
        },
    ...
    },
    {
      ...
      carts: [
        {
          title: "Home Page",
          imageSrc: "src/ProjectImg/roommate/Home.png",
        },
        {
          title: "About Page",
          imageSrc: "src/ProjectImg/roommate/about.png",
        },
        {
          title: "Team member Page",
          imageSrc: "src/ProjectImg/roommate/team.png",
        },
        // ... Add other cart data as needed
      ],
    },
